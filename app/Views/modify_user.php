								...
								<div id="kt_app_content" class="app-content">
									...
									<div id="kt_app_content_container" class="app-container container-xxl pl-1">
										...
										<form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row"
											...
											action="<?php echo base_url(); ?>ModifierUtilisateur?id=<?=$user["id"] ?>" method="POST">
											<!--begin::Main column-->
																...
																<div class="card-body pt-0">
																	...
																	<div class="row mt-10">
																		...
																		<div class="col-md-6 fv-row">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="mdp" class="form-control" value="<?=$user["mdp"]?>" />
																			<!--end::Input-->
																		</div>
																	</div>
																	...
																	<div class="row mt-10">
																		<div class="col-md-6 fv-row ">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="apps" class="form-control" value="<?=$user["apps"]?>" />
																			<!--end::Input-->
																		</div>
																		<div class="col">
																			...
																			<select class="form-select mb-2" name="role"
																				...
																				<option value="Equipe COM" 
																				<?php
																					if ($user["role"]=="Equipe COM") {
																						?>
																						selected
																						<?php
																					}
