				...
				<div class="d-flex flex-column flex-center text-center p-10">
					...
					<div class="card card-flush w-md-650px py-5">
						<div class="card-body py-15 py-lg-20">
							<!--begin::Logo-->
							<div class="mb-7">
								<a href="../../demo26/dist/index.html" class="">
									<img alt="Logo" src="assets/media/logos/custom-2.svg" class="h-40px" />
								</a>
							</div>
							<!--end::Logo-->
							<!--begin::Title-->
							<h1 class="fw-bolder text-gray-900 mb-5">Votre plan d'actions a été ajouté avec succès</h1>
							<!--end::Title-->
							<!--begin::Text-->
							<div class="fw-semibold fs-6 text-gray-500 mb-7">Un mail va vous être envoyé ainsi qu'aux administrateurs
							<br />Merci</div>
							<!--end::Text-->
							<!--begin::Illustration-->
							<div class="mb-0">
							...
							<!--begin::Link-->
							<div class="mb-0">
								<a href="<?php echo base_url(); ?>" class="btn btn-sm btn-primary">Retourner à la page d'accueil</a>
							</div>
							<!--end::Link-->
						</div>
					</div>
